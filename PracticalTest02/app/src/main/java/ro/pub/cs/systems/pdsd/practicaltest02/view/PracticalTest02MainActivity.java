...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getwordButton = (Button)findViewById(R.id.get_meaning);
        getwordButton.setOnClickListener(getWeatherForecastButtonClickListener);
        wordTextView = (TextView)findViewById(R.id.weather_forecast_text_view);
    }
